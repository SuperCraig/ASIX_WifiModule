...
extern s16		gudpbc_SocketFD;                // Craig
extern struct sockaddr_in	gudpbc_DestAddr;        // Craig

extern s16              gudpbc_SocketFD_MBI;            //Craig 171106
extern struct sockaddr_in	gudpbc_DestAddr_MBI;    //Craig 171106
